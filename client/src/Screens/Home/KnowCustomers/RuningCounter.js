...
import Oro_currency2 from '../../../Assets/Oro-currency2.jpg';
import Oro_currency6 from '../../../Assets/Oro-currency6.jpg';
import Oro_currency12 from '../../../Assets/Oro-currency12.png';
import Oro_icon from '../../../Assets/Oro-icon.png';
import Oro_theme from '../../../Assets/Oro-theme.jpg';
...
class RuningCounter extends Component {
    ...
    render() {
        return (
            <div>
              {/* <!-- Section4 - Oro Transactions --> */}
              <div class="clearfix"></div>
	                <div class="Oro_transactions padding_80 data_background" data-background={counter}>
	                	<div class="container">
	                		<div class="row">
                                <div class="col-sm-3">
